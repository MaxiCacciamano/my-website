  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://maxidev02.vercel.com`} />
        <link rel="canonical" href={`https://maxidev02.vercel.com`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Maxi Cacciamano" />
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
          ...
          {context.sharedState.finishedLoading ? (
            <Footer githubUrl={"https://github.com/MaxiCacciamano"} hideSocialsInDesktop={true} />
          ) : (
            <></>
          )}
