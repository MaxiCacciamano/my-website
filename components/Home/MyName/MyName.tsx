...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    <div
      ...
      px-8 2xl:px-9 xl:px-56 lg:px-32  md:px-28 sm:px-8 py-32 sm:py-52  "
    >
      {/*2xl:px-72*/}
      <motion.span
      ...
      >
        A&apos;s a <span className="text-AAsecondary">software developer</span>, I possess strong problem-solving skills and am passionate 
        about creating innovative digital experiences. <br className="2xl:block hidden" />
        digital experiences. Currently, I am deeply immersed in the<span className="text-AAsecondary">Web3 space</span>,
        where I am exploring and honing my skills in the development <br className="2xl:block hidden"/>
        and design of advanced <span className="text-AAsecondary">Web3 applications.</span>
      </motion.h3>
      <motion.div
        initial={{ y: 10, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
