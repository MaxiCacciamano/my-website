...
import Redes from "./Descriptions/RedesFTTH";
import Asesor from "./Descriptions/AsesorComercial";
export default function WhereIHaveWorked() {
  ...
  const GetDescription = () => {
    switch (DescriptionJob) {
      ...
      case "Independent":
        return <Freelance />;
      case "Redes de internet FTTH":
        return <Redes />;
    }
  };
  const [DescriptionJob, setDescriptionJob] = React.useState("Asesor comercial");
  return (
...
const CompaniesBar = props => {
  ...
  return (
    ...
    >
      {/* // ? left bar Holder */}
      <div
        className=" hidden md:block bg-gray-500 relative h-2 w-0 md:h-32  
        rounded-sm md:order-0 order-1  "
      >
        {/* // ? animated left bar */}
        <motion.div
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        ...
        <CompanyButton
            ...
            CompanyName="Asesor comercial"
            BarPosition={-12}
            BarAvobePosition={1}
            DescriptionJob="Asesor comercial"
          ...
          <CompanyButton
            ...
            DescriptionJob="Independent"
            CompanyNameBackgroundColorGreen={[false,true, false, false, false, false]}
            setDescriptionJob={props.setDescriptionJob}
          />
          <CompanyButton
            ButtonOrderOfcompanyNameBackgroundColorGreen={2}
            CompanyName="Redes de internet FTTH"
            BarPosition={76}
            BarAvobePosition={257}
            DescriptionJob="Redes de internet FTTH"
